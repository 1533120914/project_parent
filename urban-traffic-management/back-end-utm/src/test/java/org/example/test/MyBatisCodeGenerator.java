...
public class MyBatisCodeGenerator {
    // 代码生成器连接数据库的配置信息
    private static String url = "jdbc:mysql://localhost:3306/urban-traffic-management?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC";
    private static String username = "root";
    private static String password = "root";
    private static String author = "黄嘉诚"; // 作者名
    // 生成的主java代码输出目录 (右击src/main/java 选择复制绝对路径)
    private static String javaOutputDir = "E:\\IdeaProjects\\project_parent\\urban-traffic-management\\back-end-utm\\src\\main\\java";
    // 生成的mapper.xml文件的输出目录
    private static String mapperOutputDir = "E:\\IdeaProjects\\project_parent\\urban-traffic-management\\back-end-utm\\src\\main\\resources\\mapper";
    // 设置父包名
