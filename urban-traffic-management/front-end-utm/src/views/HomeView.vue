      ...
      <el-menu :router="routerFlag" class="el-menu-vertical-demo" style="height: 100vh">
        ...
        <div style="display: flex; flex-direction: column; align-items: center;padding: 20px 0px">
          ...
          <div style="font-size: 16px;font-weight: bold; color: #409EFF;margin-top: 15px">
            ...
            <span v-if="account.identity==2">工作人员:</span>
            <span v-if="account.identity==3">市民:</span>
            {{ account.username}}
          </div>
        </div>
        <el-menu-item index="/user" v-if="account.identity==1">
        ...
        <el-menu-item index="/accuse-type" v-if="account.identity==2">
          <i class="el-icon-menu"></i>
          <span slot="title">投诉类型管理</span>
        </el-menu-item>
        <el-menu-item index="/accuse" v-if="account.identity==2">
          <i class="el-icon-menu"></i>
          <span slot="title">处理投诉</span>
        </el-menu-item>
        <el-menu-item index="/accuse" v-if="account.identity==1">
          <i class="el-icon-menu"></i>
          <span slot="title">删除投诉</span>
        </el-menu-item>
        <el-menu-item index="/accuse/save" v-if="account.identity==3">
          <i class="el-icon-menu"></i>
          <span slot="title">我要投诉</span>
        </el-menu-item>
        <el-menu-item index="/accuse" v-if="account.identity==3">
          <i class="el-icon-menu"></i>
